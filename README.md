...
```
Now, we'll add a Material as children of Listview where in the Material have Stacks and Row as children like here's.
```Dart
 body: ListView(
        children: <Widget>[
          Material(
...
```
next, we adding new Stack where Material and positioned as children like here.
...
```
last adding 2 Rows with 2 Containers as children. where the containers have Material as child
```Dart
Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: <Widget>[
